...
<br>  
The possibilities are endless\! I use [Heroku](www.heroku.com) to host my bot, so that when I make a change to my bot.js file and commit the changes to GitHub, it will automatically restart to bot to reflect the new changes\!